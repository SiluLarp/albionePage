<?php
//Buscador en tiempo real de las publicaciones
//index.php
//funcion dentro del index
require "../conexion.php";
//variable bnuscador
$buscadordato = &$_POST['parametroSearch'];

	$q=$conexion->real_escape_string($buscadordato);
...
if (mysqli_num_rows($buscarPublic) > 0) {//si hay registros de publicaciones del usuario mostrar los registros


while ($fila = mysqli_fetch_assoc($buscarPublic)) 
{
