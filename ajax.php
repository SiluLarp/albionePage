...
//este archivo se encarga de enlistar todos los registros
//es importante ya que muestra la lista ordenada
//modifica la cantidad te registros que se mostraran por paguina
...
<div class="listaPublicacion">
    <div>
<img src="<?php echo $imagenVenta;?>" onclick="verPublicacionFull(<?php echo $fila['id']; ?>,$('#idSesionglobal').val(),<?php echo $idUsaerWhile; ?>)" style="width: 60px;"></div>
    <table>
        <tr>
        <td colspan="2">
